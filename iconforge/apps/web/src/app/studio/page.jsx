...
export default function StudioPage() {
  ...
  // OG state
  const [ogTitle, setOgTitle] = useState("IconFull");
  ...
  const downloadZIP = async () => {
    ...
    await zipAndDownload(files, "iconfull-assets.zip");
  };
...
function buildManifest({
  ...
  return {
    ...
    description: "Assets generados con IconFull",
    start_url: "/",
    display: "standalone",
